...
! function(e, t) {
    ...
    function _e(e, t, n) {
        ...
        return (n = n || Fe(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || oe(e) || (a = k.style(e, t)), !y.pixelBoxStyles() && $e.test(a) && Be.test(t) && (r = s.width,
                i = s.minWidth,
                o = s.maxWidth,
                ...
                for (i in (g = k.event && v.global) && 0 == k.active++ && k.event.trigger("ajaxStart"),
                    ...
                    v.hasContent ? v.data && v.processData && 0 === (v.contentType || "").indexOf("application/x-www-form-urlencoded") && (v.data = v.data.replace(Lt, "+")) : (o = v.url.slice(f.length),
                        v.data && (v.processData || "string" == typeof v.data) && (f += (St.test(f) ? "&" : "?") + v.data,
                            delete v.data), !1 === v.cache && (f = f.replace(Ot, "$1"),
                            o = (St.test(f) ? "&" : "?") + "_=" + kt++ + o),
                        v.url = f + o),
...
console.log('%c- </> Có vẻ như bạn đang cố tình ăn cắp mã nguồn của tôi </>.', 'color: #444; font-size: 25px; font-family: sans-serif;');
...
welcomeText.textContent = "Designed By BuiTrungHieu";
